...
rm -rf "${OUT_DIR}"
mkdir -p "${RUNTIME_BIN_DIR}" "${RUNTIME_CONTAINERS_ETC_DIR}" "${RUNTIME_CONTAINERS_MODULES_DIR}" "${RUNTIME_PARALLAX_ETC_DIR}" "${RUNTIME_SARUS_SUITE_ETC_DIR}" "${RUNTIME_LICENSE_DIR}"
